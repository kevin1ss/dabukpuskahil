    ...
    <div class="page-container">
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="tanggal">Tanggal Cetak Buku</label>
                                                            ...
                                                            <label for="ukuran">Banyak Buku</label>
        ...
        <footer>
            <div class="footer-area">
                <p>By Ignasius Kevin Nainggolan, S.Kom, SSL</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
