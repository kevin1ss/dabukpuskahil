    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="keluar.php">Buku Keluar</a></li>
                                </ul>
                            </li>
                            <li>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="ukuran">Jenis Buku</label>
                                                            ...
                                                            <label for="penerima">Penerima Buku</label>
        ...
        <footer>
            <div class="footer-area">
                <p>By Ignasius Kevin Nainggolan, S.Kom</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Input Buku Keluar</h4>
						</div>
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								<div class="form-group">
									<label>Tanggal Buku Keluar</label>
