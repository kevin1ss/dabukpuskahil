    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../logos.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <label for="merk">Penerbit Buku</label>
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus buku ini dari daftar stock?
                                                            <input type="hidden" name="idbrg" value="<?=$idb;?>">
                                                            </div>
        ...
        <footer>
            <div class="footer-area">
                <p>Ignasius Kevin N, S.Kom, SSL</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan stok buku manual</h4>
						</div>
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								<div class="form-group">
									<label>Nama Buku</label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Buku" required>
								</div>
								<div class="form-group">
									<label>Jenis Buku</label>
									<input name="jenis" type="text" class="form-control" placeholder="Jenis / Kategori Buku">
								</div>
								<div class="form-group">
									<label>Merk Buku</label>
									<input name="merk" type="text" class="form-control" placeholder="Merk Buku">
								</div>
								<div class="form-group">
									<label>Ukuran Buku</label>
									<input name="ukuran" type="text" class="form-control" placeholder="Ukuran Buku">
								</div>
								<div class="form-group">
									<label>Stock Buku</label>
									<input name="stock" type="number" min="0" class="form-control" placeholder="Qty Buku">
								</div>
								<div class="form-group">
									<label>Satuan Buku</label>
									<select name="satuan" class="custom-select form-control">
									<option selected>Pilih satuan</option>
									<option value="kertas">Kertas</option>
                                    <option value="bukupaket">Buku&nbsp;Paket</option>
                                    <option value="bukumodul">Buku&nbsp;Modul</option>
									</select>
								</div>
								<div class="form-group">
									<label>Asal Buku</label>
									<input name="lokasi" type="text" class="form-control" placeholder="Lokasi Buku">
								</div>
